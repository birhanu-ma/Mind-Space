...
export default function ForumTable({ forums = [], query, setQuery }) {
                    ...
                    {forums.map((forum) => (
                      ...
                      >
                        ...
                        <td className="py-4 px-4 text-sm">
                          <Badge
                            className={`capitalize ${
                              forum.articleType === "main"
                                ? "bg-blue-100 text-blue-600"
                                : forum.articleType === "related"
                            }`}
                          >
                            {forum.articleType}
                          </Badge>
                        ...
                        <td className="py-4 px-4 text-right">
                          <NavLink
                            to={`/student-detail/${forum._id}/details`}
            ...
            {forums.results > 0 && (
              <div className="flex justify-between items-center mt-4 text-sm text-gray-500">
                <span>
                  ...
                  {Math.min(query.page * query.limit, forums.results)} of{" "}
                  {forums.results}
                </span>
                <div className="flex items-center gap-2">
                  ...
                  <button
                    disabled={forums.length < query.limit}
                    onClick={() =>
                      setQuery((prev) => ({ ...prev, page: prev.page + 1 }))
                    }
                  >
